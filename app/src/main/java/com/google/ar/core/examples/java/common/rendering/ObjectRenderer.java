...
public class ObjectRenderer {
    ...
    private boolean occludeOnly = false;

    public ObjectRenderer() {
    }

    public ObjectRenderer(boolean occludeOnly) {
        this.occludeOnly = occludeOnly;
    }
    ...
    private void updateModelMatrix() {
        ...
        this.modelMatrix[0] = scaleFactor;
        this.modelMatrix[5] = scaleFactor;
        this.modelMatrix[10] = scaleFactor;
        Matrix.translateM(modelMatrix, 0, offsetX, offsetY, offsetZ);
        Matrix.multiplyMM(this.modelMatrix, 0, modelMatrix, 0, this.modelMatrix, 0);
    }
    ...
    public void draw(float[] cameraView, float[] cameraPerspective, float[] colorCorrectionRgba) {
        ...
        if (occludeOnly) {
            // don't wrhite to color buffer, when this object should only occlude
    ...
    public boolean isOccludeOnly() {
        return occludeOnly;
    }

    public void setOccludeOnly(boolean occludeOnly) {
        this.occludeOnly = occludeOnly;
    }
